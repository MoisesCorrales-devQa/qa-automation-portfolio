...
const navLinks = [
    ...
    {label: "What Can I Help You With?", href: "/services"},
...
export default function SidebarMenu() {
    ...
    return (
        <>
            ...
            <nav
                className="hidden md:fixed md:inset-y-0 md:left-0 md:flex md:flex-col md:w-56 md:bg-black/50 md:backdrop-blur-md md:py-12 md:px-2 md:items-center md:gap-8 z-30">
